...
/**
 * Main Elementor K2blocks Class
 *
 * The init class that runs the Elementor K2blocks plugin.
 ...
 */
final class Elementor_K2blocks {
	...
	public function admin_notice_missing_main_plugin() {
		deactivate_plugins( plugin_basename( ELEMENTOR_K2BLOCKS ) );
...
// Instantiate Elementor_K2blocks.
new Elementor_K2blocks();
